   ...
   public  class Role_Service
    {
        ...
        public Role_Service()
        {
            con = new Data_Context();
            RoleManager = new RoleManager<ApplicationRole>(store: new RoleStore<ApplicationRole>(context: new Data_Context()));
            UserManager = new UserManager<ApplicationUser>(store: new UserStore<ApplicationUser>(context: new Data_Context()));
        }
        ...
        public bool CreateRoleSucceeded(string name)
        {
